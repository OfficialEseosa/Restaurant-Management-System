...
export default function OrderPage() {
  ...
  useEffect(() => {
    async function fetchMenu() {
      try {
        //TODO (John) call getMenuItemsWithAvailability() from menuApi and setMenuItems(result)
          ...
          {profileOpen && (
            <div className="order-page__profile-dropdown" role="menu">
              <div className="order-page__profile-info">
                <span className="order-page__profile-name">Customer</span>
                <span className="order-page__profile-role">Guest</span>
              </div>
